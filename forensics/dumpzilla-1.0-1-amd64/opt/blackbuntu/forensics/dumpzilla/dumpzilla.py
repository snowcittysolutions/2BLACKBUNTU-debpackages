...
def show_watch(varDir,watchtext = 1):
   if sys.platform.startswith('win') == True:
      ...
      print ("\n[ERROR]: Edit the header of dumpzilla and add the python3 path to the variable 'python3_path'.\nExample: python3_path = '/usr/bin/python3.3'\n")
      sys.exit()
...
Usage: dumpzilla browser_profile_directory [Options]
